...
import widget.PhotoViewAttacher;
...
public class DefaultOnDoubleTapListener implements GestureDetector.OnDoubleTapListener {
    ...
    public boolean onSingleTapConfirmed(MotionEvent e) {
        ...
        if (null != photoViewAttacher.getOnPhotoTapListener()) {
            ...
            int paddingLeft = photoViewAttacher.getImageViewPaddingLeft();
            int paddingTop = photoViewAttacher.getImageViewPaddingTop();
            displayRect.left += paddingLeft;
            displayRect.right += paddingLeft;
            displayRect.top += paddingTop;
            displayRect.bottom += paddingTop;
            if (null != displayRect) {
